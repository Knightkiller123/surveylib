package easygov.saral.harlabh.utils.barcodeutils;

/**
 * Created by apoorv on 14/03/18.
 */
...
public class ScannerOverlay extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
       setMeasuredDimension(widthMeasureSpec, heightMeasureSpec);
        /*float mAspectRatio=(float) widthMeasureSpec / (float) heightMeasureSpec;
        if (mAspectRatio == 0) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        line.setColor(getResources().getColor(R.color.magma));
